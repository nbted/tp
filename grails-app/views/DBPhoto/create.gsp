...
<html>
	...
	<body>
		<a href="#create-DBPhoto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-DBPhoto" class="content scaffold-create" role="main">
